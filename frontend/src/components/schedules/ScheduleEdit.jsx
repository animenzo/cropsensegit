...
const ScheduleEdit = () => {
  ...
  if (isLoading) return <div className="text-center mt-20 text-gray-500">Loading schedule details...</div>;
  if (isError) return <div className="text-center mt-20 text-red-500">Error loading schedule.</div>;
      ...
      */}
      <ScheduleForm 
        initialData={{
             ...
             farmId: typeof scheduleData.farmId === 'object' ? scheduleData.farmId._id : scheduleData.farmId 
        }}
