...
function Login() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-green-50 to-green-100 font-poppins p-4">
      ...
      {/* Main Card Container */}
      <div className={`relative bg-white rounded-[20px] shadow-2xl overflow-hidden w-full max-w-2xl min-h-[600px] flex flex-col md:block transition-all duration-300`}>
        ...
        >
          ...
          >
            <h1 className="font-bold text-3xl text-gray-800 mb-6 tracking-tight">Create Account</h1>
            
            <span className="text-gray-400 text-sm mb-6">Use your email for registration</span>
            ...
            <div className="md:hidden mt-8 text-sm text-gray-500">
              ...
              <button type="button" onClick={() => setIsRightPanelActive(false)} className="text-green-600 font-bold hover:underline">
                Sign In
              </button>
            </div>
          </form>
        ...
        >
          <form
            ...
            className="bg-white flex flex-col items-center justify-center h-full px-8 md:px-12 text-center"
          >
            <h1 className="font-bold text-3xl text-gray-800 mb-6 tracking-tight">Sign in</h1>
            
            <span className="text-gray-400 text-sm mb-6">Welcome back to your dashboard</span>
            ...
            <Link to="/forgot-password" className="text-sm text-gray-500 hover:text-green-600 mt-4 mb-8 transition-colors">
            ...
            <div className="md:hidden mt-8 text-sm text-gray-500">
              New here?{" "}
              <button type="button" onClick={() => setIsRightPanelActive(true)} className="text-green-600 font-bold hover:underline">
                Sign Up
              </button>
            </div>
          </form>
        ...
        >
          ...
          >
            ...
            <div className={`absolute top-0 flex flex-col items-center justify-center h-full w-1/2 transform transition-transform duration-700 ease-in-out ${isRightPanelActive ? "translate-x-0" : "-translate-x-[20%]"}`}>
              <h1 className="font-bold text-3xl mb-4">Welcome Back!</h1>
              <p className="text-sm font-light leading-relaxed px-12 mb-8 opacity-90">
                To keep connected with your farm's progress, please login with your personal info.
              </p>
              <button
            ...
            <div className={`absolute top-0 right-0 flex flex-col items-center justify-center h-full w-1/2 transform transition-transform duration-700 ease-in-out ${isRightPanelActive ? "translate-x-[20%]" : "translate-x-0"}`}>
              <h1 className="font-bold text-3xl mb-4">New Harvest?</h1>
              <p className="text-sm font-light leading-relaxed px-12 mb-8 opacity-90">
                Enter your details and start your journey with our modern farming platform.
              </p>
              <button
                className="rounded-full border-2 border-white bg-transparent text-white text-xs font-bold py-3 px-12 uppercase tracking-widest hover:bg-white hover:text-green-600 transition-all active:scale-95"
